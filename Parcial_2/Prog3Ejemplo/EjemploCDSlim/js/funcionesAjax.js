...
function MostarLogin()
{
	...
	var funcionAjax=$.ajax({
		url:"http://localhost/ProgramacionIII/Parcial_2/Prog3Ejemplo/EjemploCDSlim/index.php/mostrarlogin",
		type:"post"
...
{		
	...
	var funcionAjax=$.ajax({
		url:"http://localhost/ProgramacionIII/Parcial_2/Prog3Ejemplo/EjemploCDSlim/index.php/mostraralta",
		type:"post",
...
{		
	...
	//alert("llegue");
	var funcionAjax=$.ajax({
		url:"http://localhost/ProgramacionIII/Parcial_2/Prog3Ejemplo/EjemploCDSlim/index.php/mostrargrilla",
		type:"post",
		data:{queHacer:"que hace"}
	});
	funcionAjax.done(function(retorno){
