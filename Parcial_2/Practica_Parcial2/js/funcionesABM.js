...
function BorrarCD(idParametro)
{
	//alert("Estoy en Borrar cd y quiero borrar el cd "+idParametro);
		...
		url:"http://localhost/ProgramacionIII/Parcial_2/Practica_Parcial2/borrar",
		type:"delete",
		data:{
			//queHacer:"BorrarCD",
			id:idParametro	
...
function EditarCD(idParametro)
{
	...
	var funcionAjax=$.ajax({
		url:"http://localhost/ProgramacionIII/Parcial_2/Practica_Parcial2/modificar",
		type:"post",
		data:{
			//queHacer:"TraerCD",
			id:idParametro	
...
function GuardarCD()
{
	...
	var funcionAjax=$.ajax({
		url:"http://localhost/ProgramacionIII/Parcial_2/Practica_Parcial2/cd",
		type:"post",
		data:datosDelForm,
		cache: false,
    	contentType: false,
...
function UpdateCD()
{
	...
	var funcionAjax=$.ajax({
		url:"http://localhost/ProgramacionIII/Parcial_2/Practica_Parcial2/update",
		type:"post",
		data:datosDelForm,
		cache: false,
    	contentType: false,
