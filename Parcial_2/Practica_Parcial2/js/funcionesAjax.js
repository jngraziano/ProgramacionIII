...
function MostarLogin()
{
	...
	var funcionAjax=$.ajax({
		url:"http://localhost/ProgramacionIII/Parcial_2/Practica_Parcial2/mostrarlogin",
		type:"post"
...
{		
	...
	var funcionAjax=$.ajax({
		url:"http://localhost/ProgramacionIII/Parcial_2/Practica_Parcial2/mostraralta",
		type:"post",
...
{		
	...
	//alert("llegue");
	var funcionAjax=$.ajax({
		url:"http://localhost/ProgramacionIII/Parcial_2/Practica_Parcial2/mostrargrilla",
		type:"post",
		data:{queHacer:"que hace"}
	});
	funcionAjax.done(function(retorno){
...
{		
	...
	//alert("llegue");
	var funcionAjax=$.ajax({
		url:"http://localhost/ProgramacionIII/Parcial_2/Practica_Parcial2/mostrarmodificacion",
		type:"post",
		//data:{queHacer:"que hace"}
	});
	funcionAjax.done(function(retorno){
...
//$("#informe").html("<img src='imagenes/ajax-loader.gif' style='width: 30px;'/>");
	...
	var funcionAjax=$.ajax({
		url:"http://localhost/ProgramacionIII/Parcial_2/Practica_Parcial2/validarusuario",
		type:"post",
		data:{
...
{	
	var funcionAjax=$.ajax({
		url:"http://localhost/ProgramacionIII/Parcial_2/Practica_Parcial2/desloguear",
		type:"post"		
	});
	funcionAjax.done(function(retorno){
			//MostarBotones();
