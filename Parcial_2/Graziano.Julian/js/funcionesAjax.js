...
function MostarLogin()
{
	...
	var funcionAjax=$.ajax({
		url:"http://localhost:8080/ProgramacionIII/Parcial_2/Prog3Ejemplo/EjemploCDSlim/index.php/mostrarlogin",
		type:"post"
...
{		
	...
	var funcionAjax=$.ajax({
		url:"http://localhost:8080/ProgramacionIII/Parcial_2/Prog3Ejemplo/EjemploCDSlim/index.php/mostraralta",
		type:"post",
...
{		
	...
	//alert("llegue");
	var funcionAjax=$.ajax({
		url:"http://localhost:8080/ProgramacionIII/Parcial_2/Prog3Ejemplo/EjemploCDSlim/index.php/mostrargrilla",
		type:"post",
		data:{queHacer:"que hace"}
	});
	funcionAjax.done(function(retorno){
...
{		
	...
	//alert("llegue");
	var funcionAjax=$.ajax({
		url:"http://localhost:8080/ProgramacionIII/Parcial_2/Prog3Ejemplo/EjemploCDSlim/index.php/mostrarmodificacion",
		type:"post",
		//data:{queHacer:"que hace"}
	});
	funcionAjax.done(function(retorno){
...
//$("#informe").html("<img src='imagenes/ajax-loader.gif' style='width: 30px;'/>");
	...
	var funcionAjax=$.ajax({
		url:"http://localhost:8080/ProgramacionIII/Parcial_2/Prog3Ejemplo/EjemploCDSlim/index.php/validarusuario",
		type:"post",
		data:{
...
{	
	var funcionAjax=$.ajax({
		url:"http://localhost:8080/ProgramacionIII/Parcial_2/Prog3Ejemplo/EjemploCDSlim/index.php/desloguear",
		type:"post"		
	});
	funcionAjax.done(function(retorno){
			//MostarBotones();
